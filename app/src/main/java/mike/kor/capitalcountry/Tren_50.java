    ...
    private Country[] listC = new Country[]
            {
                    ...
                    new Country(R.string.country_50_Egypt_10),
                    new Country(R.string.country_50_Israel_11),
                    new Country(R.string.country_50_India_12),
                    new Country(R.string.country_50_Indonesia_13),
                    new Country(R.string.country_50_Iraq_14),
                    new Country(R.string.country_50_Iran_15),
                    new Country(R.string.country_50_Ireland_16),
                    new Country(R.string.country_50_Spain_17),
                    new Country(R.string.country_50_Italy_18),
                    new Country(R.string.country_50_Kazakhstan_19),
                    new Country(R.string.country_50_Canada_20),
                    new Country(R.string.country_50_China_21),
                    new Country(R.string.country_50_Colombia_22),
                    new Country(R.string.country_50_KoreaSouth_23),
                    new Country(R.string.country_50_Latvia_24),
    ...
    private Capital[] listA = new Capital[]
            {
                    ...
                    new Capital(R.string.capital_50_Cairo_10),
                    new Capital(R.string.capital_50_Jerusalem_11),
                    new Capital(R.string.capital_50_NewDelhi_12),
                    new Capital(R.string.capital_50_Jakarta_13),
                    new Capital(R.string.capital_50_Baghdad_14),
                    new Capital(R.string.capital_50_Tehran_15),
                    new Capital(R.string.capital_50_Dublin_16),
                    new Capital(R.string.capital_50_Madrid_17),
                    new Capital(R.string.capital_50_Rome_18),
                    new Capital(R.string.capital_50_NurSultanAstana_19),
                    new Capital(R.string.capital_50_Ottawa_20),
                    new Capital(R.string.capital_50_Beijing_21),
                    new Capital(R.string.capital_50_Bogota_22),
                    new Capital(R.string.capital_50_CSeoul_23),
                    new Capital(R.string.capital_50_Riga_24),
