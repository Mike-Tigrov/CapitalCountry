...
public class CountryLetterN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_n);
        ...
        ACountryList.add(new ACountry(1, "1. Намибия - Виндхук"));
        ACountryList.add(new ACountry(2, "2. Науру - Ярен"));
        ACountryList.add(new ACountry(3, "3. Непал - Катманду"));
        ACountryList.add(new ACountry(4, "4. Нигер - Ниамей"));
        ACountryList.add(new ACountry(5, "5. Нигерия - Абуджа"));
        ACountryList.add(new ACountry(6, "6. Нидерланды - Амстердам"));
        ACountryList.add(new ACountry(7, "7. Никарагуа - Манагуа"));
        ACountryList.add(new ACountry(8, "8. Ниуэ (в составе Королевства Новая Зеландия) - Алофи"));
        ACountryList.add(new ACountry(9, "9. Новая Зеландия - Веллингтон"));
        ACountryList.add(new ACountry(10, "10. Новая Каледония (заморская территория Франции) - Нумеа"));
        ACountryList.add(new ACountry(11, "11. Норвегия - Осло"));
