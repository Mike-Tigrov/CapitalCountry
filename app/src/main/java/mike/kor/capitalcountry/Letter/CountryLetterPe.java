...
public class CountryLetterPe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_pe);
        ...
        ACountryList.add(new ACountry(1, "1. Пакистан - Исламабад"));
        ACountryList.add(new ACountry(2, "2. Палау - Корор"));
        ACountryList.add(new ACountry(3, "3. Палестина - Рамалла"));
        ACountryList.add(new ACountry(4, "4. Панама - Панама"));
        ACountryList.add(new ACountry(5, "5. Папуа-Новая Гвинея - Порт-Морсби"));
        ACountryList.add(new ACountry(6, "6. Парагвай - Асунсьон"));
        ACountryList.add(new ACountry(7, "7. Перу - Лима"));
        ACountryList.add(new ACountry(8, "8. Польша - Варшава"));
        ACountryList.add(new ACountry(9, "9. Португалия - Лиссабон"));
        ACountryList.add(new ACountry(10, "10. Приднестровье (частично признана) - Тирасполь"));
        ACountryList.add(new ACountry(11, "11. Пуэрто-Рико (зависимая от США территория) - Сан-Хуан"));
