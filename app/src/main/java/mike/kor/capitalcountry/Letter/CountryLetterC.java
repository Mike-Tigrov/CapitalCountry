...
public class CountryLetterC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_c);
        ...
        ACountryList.add(new ACountry(1, "1. Центральноафриканская Республика - Банги"));
