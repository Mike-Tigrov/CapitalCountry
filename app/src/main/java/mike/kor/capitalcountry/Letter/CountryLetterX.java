...
public class CountryLetterX extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_x);
        ...
        ACountryList.add(new ACountry(1, "1. Хорватия - Загреб"));
