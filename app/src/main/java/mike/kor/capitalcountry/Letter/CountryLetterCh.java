...
public class CountryLetterCh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_ch);
        ...
        ACountryList.add(new ACountry(1, "1. Чагос (заморская территория Великобритании) - Диего-Гарсия"));
        ACountryList.add(new ACountry(2, "2. Чад - Нджамена"));
        ACountryList.add(new ACountry(3, "3. Черногория - Подгорица"));
        ACountryList.add(new ACountry(4, "4. Чехия - Прага"));
        ACountryList.add(new ACountry(5, "5. Чили - Сантьяго"));
