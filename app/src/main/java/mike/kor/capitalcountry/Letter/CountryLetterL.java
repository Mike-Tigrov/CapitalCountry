...
public class CountryLetterL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_l);
        ...
        ACountryList.add(new ACountry(1, "1. Лаос - Вьентьян"));
        ACountryList.add(new ACountry(2, "2. Латвия - Рига"));
        ACountryList.add(new ACountry(3, "3. Лесото - Масеру"));
        ACountryList.add(new ACountry(4, "4. Либерия - Монровия"));
        ACountryList.add(new ACountry(5, "5. Ливан - Бейрут"));
        ACountryList.add(new ACountry(6, "6. Ливия - Триполи"));
        ACountryList.add(new ACountry(7, "7. Литва - Вильнюс"));
        ACountryList.add(new ACountry(8, "8. Лихтенштейн - Вадуц"));
        ACountryList.add(new ACountry(9, "9. Люксембург - Люксембург"));
