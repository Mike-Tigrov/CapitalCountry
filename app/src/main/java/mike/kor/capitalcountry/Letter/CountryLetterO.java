...
public class CountryLetterO extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_o);
        ...
        ACountryList.add(new ACountry(1, "1. Объединённые арабские эмираты (ОАЭ) - Абу-Даби"));
        ACountryList.add(new ACountry(2, "2. Оман - Маскат"));
        ACountryList.add(new ACountry(3, "3. Острова Кайман (заморская территория Великобритании)- Джорджтаун"));
        ACountryList.add(new ACountry(4, "4. Острова Кука (ассоциированы с Новой Зеландией) - Аваруа"));
        ACountryList.add(new ACountry(5, "5. Острова Питкэрн (заморская территория Великобритании) - Адамстаун"));
