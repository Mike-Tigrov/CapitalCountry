...
public class CountryLetterYou extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_you);
        ...
        ACountryList.add(new ACountry(1, "1. Южная Осетия (частично признана) - Цхинвали"));
        ACountryList.add(new ACountry(2, "2. Южно-Африканская Республика (ЮАР) - Претория"));
        ACountryList.add(new ACountry(3, "3. Южный Судан - Джуба"));
