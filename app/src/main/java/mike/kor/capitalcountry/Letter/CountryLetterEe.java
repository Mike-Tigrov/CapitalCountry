...
public class CountryLetterEe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_ee);
        ...
        ACountryList.add(new ACountry(1, "1. Эквадор - Кито"));
        ACountryList.add(new ACountry(2, "2. Эритрея - Асмэра"));
        ACountryList.add(new ACountry(3, "3. Эсватини - Мбабане"));
        ACountryList.add(new ACountry(4, "4. Эстония - Таллинн"));
        ACountryList.add(new ACountry(5, "5. Эфиопия - Аддис-Абеба"));
