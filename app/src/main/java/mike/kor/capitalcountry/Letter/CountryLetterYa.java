...
public class CountryLetterYa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_ya);
        ...
        ACountryList.add(new ACountry(1, "1. Ямайка - Кингстон"));
        ACountryList.add(new ACountry(2, "2. Япония - Токио"));
