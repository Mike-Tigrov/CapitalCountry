...
public class CountryLetterBe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_be);
        ...
        ACountryList.add(new ACountry(1, "1. Вануату - Вила"));
        ACountryList.add(new ACountry(2, "2. Ватикан - Ватикан"));
        ACountryList.add(new ACountry(3, "3. Великобритания - Лондон"));
        ACountryList.add(new ACountry(4, "4. Венгрия - Будапешт"));
        ACountryList.add(new ACountry(5, "5. Венесуэла - Каракас"));
        ACountryList.add(new ACountry(6, "6. Виргинские острова (северо-восток, зависимая территория Британии) - Род-Таун"));
        ACountryList.add(new ACountry(7, "7. Виргинские острова (юго-запад, неинкорпорированная организованная территория США) - Шарлотта-Амалия"));
        ACountryList.add(new ACountry(8, "8. Восточный Тимор - Дили"));
        ACountryList.add(new ACountry(9, "9. Вьетнам - Ханой"));
