...
public class CountryLetterR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_r);
        ...
        ACountryList.add(new ACountry(1, "1. Реюньон (заморская территория Франции) - Сен-Дени"));
        ACountryList.add(new ACountry(2, "2. Российская Федерация - Москва"));
        ACountryList.add(new ACountry(3, "3. Руанда - Кигали"));
        ACountryList.add(new ACountry(4, "4. Румыния - Бухарест"));
