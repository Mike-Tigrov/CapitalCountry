...
public class CountryLetterD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_d);
        ...
        ACountryList.add(new ACountry(1, "1. Дания - Копенгаген"));
        ACountryList.add(new ACountry(2, "2. Джерси (Коронная земля Великобритании) - Сент-Хельер"));
        ACountryList.add(new ACountry(3, "3. Джибути - Джибути"));
        ACountryList.add(new ACountry(4, "4. Доминика - Розо"));
        ACountryList.add(new ACountry(5, "5. Доминиканская Республика - Санто-Доминго"));
