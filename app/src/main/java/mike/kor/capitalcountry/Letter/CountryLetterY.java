...
public class CountryLetterY extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_y);
        ...
        ACountryList.add(new ACountry(1, "1. Уганда - Кампала"));
        ACountryList.add(new ACountry(2, "2. Узбекистан - Ташкент"));
        ACountryList.add(new ACountry(3, "3. Украина - Киев"));
        ACountryList.add(new ACountry(4, "4. Уоллис и Футуна (заморское сообщество Франции) - Мата-Уту"));
        ACountryList.add(new ACountry(5, "5. Уругвай - Монтевидео"));
