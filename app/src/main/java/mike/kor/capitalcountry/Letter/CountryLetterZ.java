...
public class CountryLetterZ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_z);
        ...
        ACountryList.add(new ACountry(1, "1. Замбия - Лусака"));
        ACountryList.add(new ACountry(2, "2. Зимбабве - Хараре"));
        ACountryList.add(new ACountry(3, "3. Западная Сахара (частично признана) - Эль-Аюн (заявленная) / Тифарити (фактическая)"));
