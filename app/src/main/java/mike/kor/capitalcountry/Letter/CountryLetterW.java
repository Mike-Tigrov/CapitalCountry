...
public class CountryLetterW extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_country_letter_w);
        ...
        ACountryList.add(new ACountry(1, "1. Шпицберген (автономия Норвегии) - Лонгйир"));
        ACountryList.add(new ACountry(2, "2. Швейцария - Берн"));
        ACountryList.add(new ACountry(3, "3. Швеция - Стокгольм"));
        ACountryList.add(new ACountry(4, "4. Шри-Ланка - Коломбо"));
